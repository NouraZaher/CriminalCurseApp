...
public class PortraitCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {
    ...
    public PortraitCameraView(Context context, int cameraId) throws CameraAccessException {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    if ((getLayoutParams().width == RelativeLayout.LayoutParams.MATCH_PARENT) && (getLayoutParams().height == RelativeLayout.LayoutParams.MATCH_PARENT))
